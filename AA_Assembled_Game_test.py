...
class End:
    def __init__(self,score):
        ...
        self.end_heading.grid(row=0, padx=5)
        ...
        # Export, Retry, Quit
        self.end_buttons = Frame(self.end_frame)
        self.end_buttons.grid(row=2)

        # Export button row 0 column 0
        self.end_export_button = Button(self.end_buttons, text="Export", font="Helvetica 13 bold",
                                        command=lambda:to_export)
        self.end_export_button.grid(row=0, column=0,padx=5)

        # Retry Button row 0 column 1
        self.end_retry_button = Button(self.end_buttons, text="Retry", font="Helvetica 13 bold",
                                       command=self.to_start)
        self.end_retry_button.grid(row=0, column=1, padx=5)

        # Quit button row 0 column 2
        self.end_quit_button = Button(self.end_buttons, text="Quit", font="Helvetica 13 bold",
                                      command=root.destroy)
        self.end_quit_button.grid(row=0, column=2, padx=5)
