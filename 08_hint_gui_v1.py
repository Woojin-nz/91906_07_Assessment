...
class Start:
    def __init__(self):
        ...
        # Help Button (row 1)
        self.help_button = Button(self.converter_frame, text="Hint",
                                  font=("Arial", "8", "bold"),
                                  bg=background_color,
                                  padx=10, pady=10,
                                  command=self.help)
    ...
    def help(self):
        get_help = Help(self)
        get_help.help_text.configure(text="The corresponding country is located in the {} continent".format(continent))
